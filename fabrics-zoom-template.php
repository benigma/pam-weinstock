<?php
/*
Template Name: Fabrics Zoom Page Template
*/
?>
<?php get_header(); ?>
...
<div class="container">
	...
	<div class="sales-area">
		...
		<div class="sales-image">
			...
			<?php echo the_field('product_image'); ?>
		...
		<div class="sales-information">
			...
			<button onClick="parent.location='mailto:hello@pamweinstock.com?subject=<?php echo the_title(); ?> Wallpaper Enquiry'">Make an Enquiry</button>
	...
	<div class="additional-sales-items">
		...
		<div class="additional-sales-images">
			...
			<?php if( have_rows('additional_enquiry_items') ): ?>
				...
				<div class="additional-sales-intro">Additional examples of <?php echo the_title(); ?></div>
